...
from src.infrastructure.config.config import GameState as GameStateEnum
...
def main():
    ...
    engine.register_state(GameStateEnum.MAIN_MENU, MainMenuState)
    engine.register_state(GameStateEnum.LOADING, LoadingScreenState)
    engine.register_state(GameStateEnum.GAMEPLAY, GameplayState)
